...
Maximum apparent magnitude measurements are converted into distance from the observer by applying the following definition: <img src="https://latex.codecogs.com/gif.latex?m&space;-&space;M&space;-&space;A_v&space;=&space;5&space;\log{\frac{d}{10}}" title="m - M - A_v = 5 \log{\frac{d}{10}}" />, or <img src="https://latex.codecogs.com/gif.latex?d&space;=&space;10^{\frac{5&space;&plus;&space;m&space;-&space;M&space;-&space;A_v}{5}}" title="d = 10^{\frac{5 + m - M - A_v}{5}}" />, where <img src="https://latex.codecogs.com/gif.latex?m" title="m" /> and <img src="https://latex.codecogs.com/gif.latex?M" title="M" /> are the apparent and absolute maximum magnitude of the supernova, respectively, <img src="https://latex.codecogs.com/gif.latex?A_v" title="A_v" /> is its extinction in the visible band and <img src="https://latex.codecogs.com/gif.latex?m" title="d" /> is its distance in Parsec (pc). 
